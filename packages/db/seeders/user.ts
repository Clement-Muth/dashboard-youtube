...
const users: Omit<IUser, "id">[] = [
  {
    email: "john.peter@dashboard.com",
    lastName: "Peter",
    firstName: "John",
    ...
    companyAddress:
      "{'label':'22 Rue d'Eschau, Strasbourg, France','value':{'description':'22 Rue d'Eschau, Strasbourg, France','matched_substrings':[{'length':2,'offset':0},{'length':12,'offset':3}],'place_id':'ChIJ58NGQHbLlkcR6x-QcdEw7KM','reference':'ChIJ58NGQHbLlkcR6x-QcdEw7KM','structured_formatting':{'main_text':'22 Rue d'Eschau','main_text_matched_substrings':[{'length':2,'offset':0},{'length':12,'offset':3}],'secondary_text':'Strasbourg, France'},'terms':[{'offset':0,'value':'22'},{'offset':3,'value':'Rue d'Eschau'},{'offset':17,'value':'Strasbourg'},{'offset':26,'value':'France'}],'types':['street_address','geocode']}}",
    companyName: "Dashboard",
    companyPhone: "01 78 34 12 89",
    companySiren: "127-938-502",
    companySocialDenomination: "Agence web",
    contactEmail: "john.peter@dashboard.com",
    userType: "professional"
  },
  {
    email: "elio.alexis@dashboard.com",
    lastName: "Elio",
    firstName: "Elio",
    picture:
    ...
    companySocialDenomination: "Agence web",
    contactEmail: "elio.alexis@dashboard.com",
    userType: "professional"
  }
];
