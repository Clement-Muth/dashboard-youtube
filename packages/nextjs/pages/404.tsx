import { defaultLocale } from "@libraries/translation/config";
...
const Page404: NextPage = () => {
  return (
    <>
      <NextSeo canonical="https://dashboard.com/404" title="Erreur 404" description="Erreur 404" noindex nofollow />
      <Flex>
...
export const getStaticProps: GetStaticProps = async (ctx) => {
  const locale = ctx.params?.lang || defaultLocale;

  return {
    props: { locale, projectMenu: true, footer: false }
  };
};
