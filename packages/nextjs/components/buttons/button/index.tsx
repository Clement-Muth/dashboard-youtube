...
export interface ButtonProps extends FlexProps, Partial<Pick<TextProps, "dataDashboardId">> {
  id?: string;
...
export const Button: React.FC<ButtonProps> = ({
  ...
  React.useEffect(() => {
    ...
    // @ts-ignore
    buttonRef.current.firstChild.setAttribute("data-dashboard-id", props.dataDashboardId);
  }, [buttonRef]);
