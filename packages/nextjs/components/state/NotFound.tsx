...
export interface NotFoundProps extends Pick<TextProps, "dataDashboardId"> {
  title: string;
  onClick?: () => void;
}

export const NotFound = ({ title, onClick, dataDashboardId }: NotFoundProps) => {
  ...
  return (
    ...
    >
      <Flex height="fit-content" m="auto" flexDirection="column">
        ...
        <Text as="h1" dataDashboardId={dataDashboardId} textAlign="center" mt={2}>
          {title}
        </Text>
      </Flex>
    </Flex>
